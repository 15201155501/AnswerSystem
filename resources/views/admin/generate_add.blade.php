       ...
       <div class="col-xs-12">
        ...
        <div class="row">
         <div class="col-xs-12">
          ...
          <form action="generate_addPro" method="post" onsubmit="return submits()" enctype="multipart/form-data">
          <center>
           <table id="sample-table-1" class="table table-striped table-bordered table-hover">
            ...
            <tr>
              <td align="center">是否开放</td>
              <td>
                <input type="radio" name="is_open" value="1">是 <input type="radio" name="is_open" value="0">否
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <input type="text" name="start_time"  value="" id="start_time" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')"/>
              </td>
            </tr>
            <tr>
              <td align="center">结束时间</td>
              <td>
                <input type="text" name="end_time"  value="" onblur="checks()" id="end_time" onclick="SelectDate(this,'yyyy-MM-dd hh:mm:ss')"/><span id="tishi"></span>
              </td>
            </tr>
            <tr>
