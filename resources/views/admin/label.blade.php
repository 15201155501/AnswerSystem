    ...
    <div class="main-container" id="main-container">
     ...
     <div class="page-content"> 
      <div class="page-header"> 
       <h1> 标签添加<small> <i class="icon-double-angle-right"></i></small> </h1> 
      </div>
         ...
         <div class="col-xs-12"> 
          ...
          <center>
           <table id="sample-table-1" class="table table-striped table-bordered table-hover"> 
            <tr>
              <td align="center">父级标签</td>
              <td>
                <select name="pid" id="">
                  <option value="0">顶级权限</option>
                  @foreach($arr as $v)
                  <option value="{{$v['lid']}}">{{str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$v['level'])}}{{$v['lname']}}</option>
                  @endforeach
                </select>
              </td>
            </tr>
